...
OUTPUT_PDF = "Global_individual_heatmap_pairwise_clustered.pdf"
COLOR_LIMIT = 2.0
...
def main():
    ...
    title_ax.text(
        0.5,
        0.20,
        "Genes clustered by pairwise expression similarity and oriented from higher to lower mean expression; "
        "samples clustered within cohort",
        ha="center",
        va="center",
        fontsize=9
    )
